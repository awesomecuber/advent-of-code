...
opcode_param_count = {1: 3, 2: 3, 3: 1, 4: 1, 5: 2, 6: 2, 7: 3, 8: 3, 99: 0}
...
class IntCodeProgram:
    ...
    def run(self, input):
        ...
        while True:
            ...
            match opcode:
                case 1:
                    self.memory[params[2]] = self.get_num(
                        params[0], param_modes[0]
                ...
                case 6:
                    if self.get_num(params[0], param_modes[0]) == 0:
                        ...
                        cursor_changed = True
                case 7:
                    if self.get_num(params[0], param_modes[0]) < self.get_num(
                        params[1], param_modes[1]
                    ):
