...
rooms = {
    2: [
        Amphipod[puzzle_input[3][3]],
        Amphipod.D,
        Amphipod.D,
        Amphipod[puzzle_input[2][3]],
    ],
    4: [
        Amphipod[puzzle_input[3][5]],
        Amphipod.B,
        Amphipod.C,
        Amphipod[puzzle_input[2][5]],
    ],
    6: [
        Amphipod[puzzle_input[3][7]],
        Amphipod.A,
        Amphipod.B,
        Amphipod[puzzle_input[2][7]],
    ],
    8: [
        Amphipod[puzzle_input[3][9]],
        Amphipod.C,
        Amphipod.A,
        Amphipod[puzzle_input[2][9]],
    ],
}
...
def best_energy(
    ...
    if all(
        not possible_to_leave(pos, room) and len(room) == ROOM_SIZE
    ...
    for pos, moving in enumerate(hallway):
        ...
        if (
            ...
            enter_energy = moving.value * (
                ROOM_SIZE + 1 - len(new_rooms[destination_room])
            )
